...
Construí un side project este último mes. Un todo list pequeño con asistente de IA y timer pomodoro integrado. Un sandbox para probar patrones de Next.js que no había tocado y romper cosas a propósito.
...
Así se ve uno de mis specs, corto a propósito. Este era para tareas recurrentes:

- **Objetivo:** crear tareas recurrentes (diaria, semanal, mensual) editables individualmente sin romper la serie.
- **No-objetivos:** soporte completo de RRULE de iCal, excepciones por zona horaria.
- **Casos borde:** tarea que cae en cambio de DST, instancia eliminada vs. serie eliminada, semántica de "este y los siguientes".
