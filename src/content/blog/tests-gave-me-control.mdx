...
<TLDR bullets={[
  "I worked a month with Claude Code on a side project. /insights showed me two things: AI patches symptoms before understanding causes, and tests are the only thing that lets me trust its changes.",
  "This post is what I changed because of that.",
]} />
...
- Custom skills with eval benchmarks pay off. I'd been building these for fun. `/insights` tagged them as the most reliable lever I had.
