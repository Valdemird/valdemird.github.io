...
I built a side project this past month. A small todo app with an AI assistant and a built-in Pomodoro timer. A sandbox to try Next.js patterns I hadn't touched and break things on purpose.
...
- Custom skills with eval benchmarks pay off. I'd been building these for fun, things like auditing accessibility or reviewing PRs against a fixed checklist. `/insights` tagged them as the most reliable lever I had.
...
Here's what one of my specs looks like, kept short on purpose. This one was for recurring tasks:

- **Goal:** create recurring tasks (daily, weekly, monthly) that can be edited individually without breaking the series.
- **Non-goals:** full iCal RRULE support, timezone-based exceptions.
- **Edge cases:** task falling on a DST switch, deleted instance vs. deleted series, "edit this and following" semantics.
